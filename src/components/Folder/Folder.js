    ...
    >
      <List.Icon
        name={
          ...
          (props.data.open || props.openedFolder.includes(`${props.data.id}`))
            ? "folder outline open"
            : "folder outline "
        }
      />
      <List.Content>
        <input
          ...
          onKeyDown={props.pushEnterFunction}
        ...
        >
          {props.data.name}
          {Number(props.selectedFolderId) === props.data.id ? (
            <Icon
              color="red"
              name="check circle"
              size="small"
            ...
            <Icon name="check circle" size="small" data-id={props.data.id} />
          )}
          <Fragment>
            <Button icon className="none" color="white" data-id={props.data.id}>
              <Icon
                ...
                onClick={folderEditBtn}
                data-id={props.data.id}
              />
              <Segment.Group compact className="none">
                <Segment textAlign="center" onClick={props.addFolder}>
                  Add Folder
                </Segment>
                <Segment textAlign="center" onClick={props.editName}>
                  Edit Name
                </Segment>
                <Segment textAlign="center" onClick={props.delete}>
                  Delete
                </Segment>
              </Segment.Group>
            </Button>
