  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if (this.props.inYoutube) {
      if (this.guideForInitFocus === 0) {
        ...
        if (
          this.avoidAddFolderFunc.length === 0 &&
          this.props.selectedFolderId !== prevProps.selectedFolderId
        ) {
          this.urlInput.current.querySelector("input").focus();
        } else {
          this.avoidAddFolderFunc = [];
  ...
  render() {
    return (
      <div className="URLInput" ref={this.urlInput}>
        <div className="buttonCase" onClick={this.changeView.bind(this)}>
        ...
        <Input
          ...
          label={{
            tag: true,
            content: "Add",
            onClick: this.props.inYoutube ? this.setTimeMarker.bind(this) : ""
          }}
          labelPosition="right"
          placeholder={
            this.props.inYoutube ? "Mark Name..." : "Use in VideoPage..."
          }
        ...
        <Input
          ...
          label={{
            tag: true,
            content: "Search",
            onClick: this.searchInputVal.bind(this)
          }}
          labelPosition="right"
          placeholder="Search..."
